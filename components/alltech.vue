...
import pythonTextureLader from "~/assets/images/polygon.png";
import javascriptTextureLader from "~/assets/images/next.png";
import nodejsTextureLader from "~/assets/images/nest.png";
import golangTextureLader from "~/assets/images/flutter.png";
